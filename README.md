# WebScrapping con Selenium y Python
...
- Simular interacción real con páginas web
- Extraer información de sitios con contenido dinámico
- Comprender el funcionamiento de Selenium y ChromeDriver
- Experimentar con automatización controlada desde Python
...
* scrapping.ipynb: Notebook base con prácticas iniciales de scraping.
